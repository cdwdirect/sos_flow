...
static const char *SOS_MSG_TYPE_str[] __attribute__((__unused__)) =      { FOREACH_MSG_TYPE(GENERATE_STRING)     };
static const char *SOS_RECEIVES_str[] __attribute__((__unused__)) =      { FOREACH_RECEIVES(GENERATE_STRING)     };
static const char *SOS_FEEDBACK_TYPE_str[] __attribute__((__unused__)) = { FOREACH_FEEDBACK_TYPE(GENERATE_STRING)};
static const char *SOS_PUB_OPTION_str[] __attribute__((__unused__)) =    { FOREACH_PUB_OPTION(GENERATE_STRING)   };
static const char *SOS_QUERY_STATE_str[] __attribute__((__unused__)) =   { FOREACH_QUERY_STATE(GENERATE_STRING)  };
static const char *SOS_PRI_str[] __attribute__((__unused__)) =           { FOREACH_PRI(GENERATE_STRING)          };
static const char *SOS_GEOMETRY_str[] __attribute__((__unused__)) =      { FOREACH_GEOMETRY(GENERATE_STRING)     };
static const char *SOS_VAL_TYPE_str[] __attribute__((__unused__)) =      { FOREACH_VAL_TYPE(GENERATE_STRING)     };
static const char *SOS_VAL_STATE_str[] __attribute__((__unused__)) =     { FOREACH_VAL_STATE(GENERATE_STRING)    };
static const char *SOS_VAL_SYNC_str[] __attribute__((__unused__)) =      { FOREACH_VAL_SYNC(GENERATE_STRING)     };
static const char *SOS_VAL_FREQ_str[] __attribute__((__unused__)) =      { FOREACH_VAL_FREQ(GENERATE_STRING)     };
static const char *SOS_VAL_SEMANTIC_str[] __attribute__((__unused__)) =  { FOREACH_VAL_SEMANTIC(GENERATE_STRING) };
static const char *SOS_VAL_PATTERN_str[] __attribute__((__unused__)) =   { FOREACH_VAL_PATTERN(GENERATE_STRING)  };
static const char *SOS_VAL_COMPARE_str[] __attribute__((__unused__)) =   { FOREACH_VAL_COMPARE(GENERATE_STRING)  };
static const char *SOS_VAL_CLASS_str[] __attribute__((__unused__)) =     { FOREACH_VAL_CLASS(GENERATE_STRING)    };
static const char *SOS_REGEX_str[] __attribute__((__unused__)) =         { FOREACH_REGEX(GENERATE_STRING)        };
static const char *SOS_SCOPE_str[] __attribute__((__unused__)) =         { FOREACH_SCOPE(GENERATE_STRING)        };
static const char *SOS_LAYER_str[] __attribute__((__unused__)) =         { FOREACH_LAYER(GENERATE_STRING)        };
