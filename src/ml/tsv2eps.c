...
/*
 *  Derived from URL: http://rosettacode.org/wiki/K-means%2B%2B_clustering#C
 *
 *  Copyright information (from source):
 *    "This page was last modified on 12 August 2016, at 23:46.
...
#define USAGE "./tsv2eps <num_pts> <num_k>"
