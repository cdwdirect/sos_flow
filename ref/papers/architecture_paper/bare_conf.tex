...
\todo[inline]{Come back and flesh out the INTRO and ABSTRACT at the end, once 
we're sure the content we are after is a part of the paper.}


\section{Motivations for Tracking Variability}
\todo[inline]{More than simply demonstrating that there are different and 
...
core density increases on the nodes of a cluster \todo[inline]{Cite paper showing this 
...
\subsection{Behavior}
\todo{Here I can introduce a narrative or a figure or both, to explain 
...
\todo{Fill in various configuration subsections.}
\section{Conclusion}
