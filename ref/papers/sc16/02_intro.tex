...
%
\todo[inline]{
However, neither of these frameworks can be configured with and used directly by an application. 
%
Additionally, they do not allow for information aggregation from multiple data sources.
}
\par
%
...
environment.
%
\todo[inline]{It is important to have a flexible means to gather information 
from different sources --- primarily the application and system environment.}
%
Because information will need to be processed online, it is important
to enable analysis in situ with the application.
%
\todo[inline]{Additionally, for the gathered information to be processed online,
...
%
\todo[inline]{Furthermore, query and control interfaces are required to facilitate 
an active application feedback process. 
%
The analysis performed can be used to give feedback to both the application and the system.}
%
