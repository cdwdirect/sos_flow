...
Applying the SOS model to the complex and highly variable
behavior of scientific workflows led to the creation of the SOSflow
runtime software system.

\subsection{Design Rationale}
%%%%%
SOSflow contributes a general solution to in situ
...
diversity and case-by-case optimality, SOSflow's must be implemented
independent of the technology used in the scientific workflows it
monitors.
%
All information that is captured in SOS should be distinct and carry with it a
set of metadata to enable classification and reasoning over it.
%
SOSflow should aggregate necessary information together at run-time to
enable high level reasoning over the entire monitored workflow.
%
These requirements inform the features of SOSflow and a general
solution to in situ observation, introspection, feedback, and control.
%%%%%
...
%
SOSflow is intended to be a widely-integrated programmable middleware
that evolves low-level optimizations over time, with a broad set of
functionality that is available to all developers and users of
scientific workflows, regardless of job scale.
%
...
%
There are no a priori constraints prohibiting workflows from deriving
utility from the general solution SOSflow presents for on-line in situ
monitoring, analytics, feedback, and control.
%
...
data.
%
Workflow execution environments provide the basis for comparing, validating, and selecting a particular means for achieving
the SOSflow model.
%
