...
\section{Properties and Means of Operation}
...
performance.
%
Almost nothing that can be done to control or eliminate the variance
introduced by hardware components.
%
Performance data derived from noisy hardware has to be admitted into
the results alongside data from well-behaved machines.
%
Keeping track of \textit{when and where}, not merely how, a
program ran is growing in significance to all HPC experiments with an
