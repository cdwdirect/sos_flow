...
result.
%
These components can be instantiated as threads of a single process, but
more often they are independent processes.
%
Components are functionally independent of each other and capable of
being dynamically instantiated and terminated.
%
Any general solution for monitoring entire workflows will need to
exist outside of the lifecycle of a given single component.
%
...
workflows.
%
The optimal transport mechanism for a flow will depend on many
factors, such as the overall magnitude of information, operational
element size, update frequency, locality, and format commonality.
%
...
given component, and is not a priori tailored for the nature of one
