...
find_program (EVPath_CONFIG NAMES evpath_config 
  ...
  if(EVPath_CONFIG)
    ...
    FIND_LIBRARY(EVPath_LIBRARY NAMES libenet.a PATHS
        "${EVPath_DIR}/lib" NO_DEFAULT_PATH)
    FIND_LIBRARY(EVPath_LIBRARY NAMES enet)

    endif()
    
endif(EVPath_CONFIG)

IF (EVPath_INCLUDE_DIR AND EVPath_LIBRARY)
   SET(EVPath_FOUND TRUE)
ENDIF (EVPath_INCLUDE_DIR AND EVPath_LIBRARY)
