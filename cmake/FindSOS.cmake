...
message("SOS_ROOT is defined as ${SOS_ROOT}")

find_path(SOS_INCLUDE_DIR NAMES sos.h HINTS ${SOS_ROOT}/include)
find_library(SOS_LIBRARY NAMES sos HINTS ${SOS_ROOT}/lib)
