...
export SOS_JOB_TITLE="33.lulesh"
...
export JOB_LAUNCH_COMMAND="-N 32 -n 512 -r 1 ./lulesh_par -i 20"
export JOB_BINARY_PATH=$PROJECT_BASE/sos_vpa_2017/matt/lulesh2.0.3
cp $JOB_BINARY_PATH/lulesh_par $SOS_WORK
