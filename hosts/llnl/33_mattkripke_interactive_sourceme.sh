...
export SOS_JOB_TITLE="33.kripke"
...
#export JOB_LAUNCH_COMMAND="-N 32 -n 512 -r 1 ./kripke_par --procs 8,8,8 --zones 64,64,64 --niter 1 --grp 1:1 --legendre 4 --quad 20:20 --dir 50:1"
export JOB_LAUNCH_COMMAND="-N 32 -n 512 -r 1 ./kripke_par --procs 8,8,8 --zones 64,64,64 --niter 480 --grp 1:1 --legendre 4 --quad 20:20 --dir 50:1"
